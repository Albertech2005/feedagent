    ...
    <div className="min-h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-8 px-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-900/30 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-800 p-8">
            <button
              onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-900 font-medium rounded-xl hover:bg-gray-100 transition-colors"
            >
            ...
            <div className="mt-6 text-center text-gray-400 text-sm">
              <p>No account needed - Google will create one automatically</p>
            </div>
          </div>
        </div>
      </div>
